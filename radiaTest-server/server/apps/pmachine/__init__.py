...
def init_api(api: Api):
    api.add_resource(PmachineEvent, "/api/v1/pmachine", "/api/v1/ws/<str:workspace>/pmachine")
    ...
    api.add_resource(MachineGroupEvent, "/api/v1/machine-group", "/api/v1/ws/<str:workspace>/machine-group")
