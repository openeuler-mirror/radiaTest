<template>
  <transition name="mode-fade" mode="out-in">
    <div style="height: 100%" v-if="!showWorkbench" @wheel="handleWheelDown">
      <img class="img" src="/programming.png" />
      <div class="homeContent">
        ...
        <n-space class="quickSpace">
          ...
          <home-button class="quickButton" @click="handleJobClick" invert-color>
            测试看板
          </home-button>
                ...
                <div class="ge-dashboard-module-collection-view">
                  <div class="ge-dashboard-module-collection-view-header mb-3 ">
                    ...
                    <div class="searchWrap ml-auto">
                      <n-icon size="22" class="search" @click="machineSearch"> <Search /> </n-icon>
                      <n-input
                        type="text"
                        placeholder="搜索..."
                        class="input"
